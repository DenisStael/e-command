...
public class TelaRelatorioController {
   ...
   private ResultSet rs,rs2;
                ...
                if(data != null && data2 != null) {
                    if((data.isEqual(data2) || data.isBefore(data2))) {
                        try {
                            ...
                            doc.add(new Paragraph("                                                "));
                            doc.add(new Paragraph("                                                "));
                            doc.add(new Paragraph("         Tabela do estoque de produtos: "));
                            doc.add(new Paragraph("                                                "));
                            ...
                            PreparedStatement ps2 = ConexaoBanco.getConnection().prepareStatement("select codpedido,precototal, data_pedido from pedido where data_pedido between ? and ?;");
                            ps2.setDate(1, Date.valueOf(data));
                            ps2.setDate(2, Date.valueOf(data2));
                            rs2 = ps2.executeQuery();

                            doc.add(new Paragraph("                 RELATÓRIO DE LUCRO             "));
                            doc.add(new Paragraph("                                                "));
                            doc.add(new Paragraph("                                                "));
                            doc.add(new Paragraph("                                                "));
                            doc.add(new Paragraph("         Tabela dos pedidos: "));
                            doc.add(new Paragraph("                                                "));
    ...
    public void acaoHoje(ActionEvent actionEvent) {
    }
}
